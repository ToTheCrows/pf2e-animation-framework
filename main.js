 ...
 * Version 1.4.6 - "The Tactical Precision"
 * Master Grimoire: Damage-Roll Filter, All Classes (deep), Spells Lvl 1-4.
 */
...
const ANIMATIONS = {
    ...
    classes: {
        fighter: {
            ...
            "Reactive Strike": "jb2a.melee_generic.slashing.two_handed", "Knockdown": "jb2a.impact.002.yellow",
            "Vicious Swing": "jb2a.melee_generic.slash.02.001.orange.0", "Combat Grab": "jb2a.impact.008.orange"
        },
        monk: {
            "Flurry of Blows": "jb2a.melee_generic.creature_attack.fist.001.yellow.0", "Ki Strike": "jb2a.impact.001.blue",
            "Stunning Fist": "jb2a.unarmed_strike.magical.02.blue",
            "Mountain Stance": "jb2a.magic_signs.circle.02.transmutation.complete.yellow",
            "Crane Stance": "jb2a.magic_signs.circle.02.divination.complete.dark_yellow",
            "Ki Blast": "jb2a.shatter.blue", "Whirling Throw": "jb2a.whirlwind.blue"
        },
        barbarian: {
            "Rage": "jb2a.ground_cracks.02.orange", "Sudden Charge": "jb2a.impact.01.yellow",
            "Terrifying Howl": "jb2a.shatter.red", "Thrash": "jb2a.melee_generic.bludgeoning.two_handed",
            "Animal Rage": "jb2a.claws.200px.bright_blue", "Cleave": "jb2a.melee_generic.slashing.two_handed"
        },
        ranger: {
            "Hunt Prey": "jb2a.magic_signs.circle.02.divination.intro.green", "Gravity Weapon": "jb2a.impact.009.purple",
            "Hunted Shot": "jb2a.arrow.physical.white.02", "Twin Takedown": "jb2a.melee_generic.slashing",
            "Heal Companion": "jb2a.healing_generic.burst.greenorange", "Soothing Mist": "jb2a.healing_generic.03.burst.bluegreen",
            "Crossbow Ace": "jb2a.bolt.physical.orange", "Animal Feature": "jb2a.claws.200px.bright_yellow"
        },
        rogue: {
            "Debilitating Strike": "jb2a.markers.skull.dark_green.01", "Mobility": "jb2a.misty_step.01.blue",
            "Surprise Attack": "jb2a.misty_step.01.green", "Quick Draw": "jb2a.melee_generic.slash.02.002.blue.1"
        },
        cleric: {
            "Raise Shield": "jb2a.markers.shield.blue.02", "Emblazon Armament": "jb2a.magic_signs.circle.02.abjuration.intro.yellow",
            "Sanctify Weapon": "jb2a.spiritual_weapon.sword.flaming.yellow", "Divine Font": "jb2a.healing_generic.burst.yellowwhite",
            "Holy Blast": "jb2a.shatter.01.yellow"
        },
        investigator: {
            "Devise a Stratagem": "jb2a.magic_signs.circle.02.divination.intro.dark_blue",
            "Known Weakness": "jb2a.magic_signs.circle.02.divination.outro.dark_yellow",
            "Suspect of Opportunity": "jb2a.magic_signs.circle.02.divination.complete.dark_green",
            "Clues": "jb2a.magic_signs.circle.02.enchantment.complete.dark_pink"
        },
        gunslinger: {
            "Firearm Strike": "jb2a.bullet.01.orange", "Reload": "jb2a.fumes.steam.white",
            "Slinger's Reload": "jb2a.fumes.steam.white", "Gunslinger's Dodge": "jb2a.misty_step.01.blue",
            "Risky Reload": "jb2a.fumes.steam.white", "Ten Paces": "jb2a.impact.004.orange"
        },
        druid: {
            "Wild Shape": "jb2a.magic_signs.circle.02.transmutation.intro.green", "Untamed Form": "jb2a.magic_signs.circle.02.transmutation.intro.green",
            "Goodberry": "jb2a.healing_generic.200px.green", "Animal Vision": "jb2a.magic_signs.circle.02.divination.intro.green"
        },
        mage: {
            "Arcane Cascade": "jb2a.antilife_shell.blue_with_circle", "Counterspell": "jb2a.magic_signs.circle.02.abjuration.complete.red",
            "Drain Bond": "jb2a.magic_signs.circle.02.transmutation.outro.blue", "Drain Bond Item": "jb2a.magic_signs.circle.02.transmutation.outro.blue",
            "Hand of the Apprentice": "jb2a.arcane_hand.rainbow", "Call Staff": "jb2a.spiritual_weapon.quarterstaff.01.astral.01.blue"
        },
        sorcerer: {
            "Dangerous Sorcery": "jb2a.whirlwind.red", "Sorcerous Potency": "jb2a.magic_signs.circle.02.evocation.intro.red",
            "Ancestral Memories": "jb2a.magic_signs.circle.02.divination.loop.purple", "Bloodline Focus": "jb2a.magic_signs.circle.02.necromancy.intro.red"
        }
    },
    ...
    spells: {
        level1: {
            ...
            "Heal": "jb2a.healing_generic.burst.bluewhite", "Harm": "jb2a.cast_generic.01.dark_purple.0",
            ...
            "Mage Armor": "jb2a.magic_signs.circle.01.abjuration.intro.blue", "Color Spray": "jb2a.color_spray.01.rainbow"
        },
        level2: {
        ...
        level3: {
            ...
            "Heroism": "jb2a.magic_signs.circle.02.divination.intro.yellow", "Vampiric Touch": "jb2a.vampiric_touch.01.purple"
        },
        level4: {
            "Dimension Door": "jb2a.misty_step.01.blue", "Translocate": "jb2a.misty_step.01.blue",
            "Phantasmal Killer": "jb2a.phantasmal_killer.01.purple", "Stoneskin": "jb2a.magic_signs.circle.01.abjuration.intro.yellow",
            "Searing Light": "jb2a.ray.01.white", "Fly": "jb2a.wind_directional.white"
        }
    },
...
Hooks.once('ready', () => {
    console.log("PF2e Animation Framework | 1.4.4: Master Grimoire online (Tactical Precision).");
});
...
Hooks.on("createChatMessage", async (message, options, userId) => {
    ...
    // Ignoriere Schadenswürfe konsequent, um Doppel-Animationen zu vermeiden
...
>>>>>>> 1486d9ed2ece712a0324c196046b6cc6eadae20a
});